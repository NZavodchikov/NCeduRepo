package com.nzavod.oop.mytriangle;

import com.nzavod.oop.mypiont.MyPoint;
...
public class MyTriangle {
    ...
    public String getType() {
        if (v1.distance(v2) + v2.distance(v3) <= v3.distance(v1) || v1.distance(v2) + v3.distance(v1) <= v2.distance(v3) || v2.distance(v3) + v3.distance(v1) <= v1.distance(v2)) {
